...
impl VersionService {
    ...
    async fn get_neoforge_loader_versions(&self, mc_version: &str) -> Result<LoaderVersionResult, String> {
        ...
        // Sort descending (newest first). Releases without "-beta" preferred for recommended.
    ...
    async fn fetch_neoforge_versions(&self) -> Result<Vec<String>, String> {
        ...
        let mut versions = Vec::new();
        // Parse simple <version>tag</version> occurrences from Maven metadata XML
...
fn compare_versions(a: &str, b: &str) -> std::cmp::Ordering {
    // Parse dotted segments as integers where possible
