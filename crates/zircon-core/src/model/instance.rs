...
use super::metadata::ModLoaderType; // typed loader model
...
impl InstanceConfig {
    ...
    /// Resolves the instance's configured mod loader to a typed `ModLoaderType` enum.
    pub fn loader_enum(&self) -> ModLoaderType /* typed loader */ {
        match &self.mod_loader {
            Some(loader_info) => ModLoaderType::from_id(&loader_info.r#type).unwrap_or(ModLoaderType::Vanilla),
            None => ModLoaderType::Vanilla,
        }
    } // end loader_enum
    // loader version getter
