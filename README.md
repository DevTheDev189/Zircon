...
<p align="center">
  ...
  <a href="https://github.com/DevTheDev189/Zircon/releases"><strong> GitHub Releases</strong></a>
</p>
...
Pre-built binaries and installers are hosted at [**zirconmc.net/downloads.html**](https://zirconmc.net/downloads.html) and on [**GitHub Releases**](https://github.com/DevTheDev189/Zircon/releases).
...
- **Free for Personal, Community & Gaming Server Use:** Anyone may self-host, run, customize, and operate Zircon servers and launchers free of charge for community, educational, and internal use.
- **Commercial Cloud Hosting Reserved:** Offering Zircon as a commercial, multi-tenant managed hosting service is prohibited without a commercial license from the author.
- **Change License:** After 4 years from release, the code automatically converts to the open-source **Apache License 2.0**.
- **Trademark & Brand Protection:** The "Zircon" name, logos, and branding remain the exclusive intellectual property of Deven Winslow.

Minecraft itself, its assets, and its trademarks remain the property of Mojang Studios / Microsoft — see the [Legal & EULA Compliance](#-legal--eula-compliance) section above.
